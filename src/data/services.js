...
export const services = [
  ...
  },
  {
    ...
    variant: 'green',
    icon: ContentCut,
    whatsappMessage: 'Oi! Tenho interesse na Tosa na Máquina e gostaria de mais informações'
  },
  {
    ...
    variant: 'green',
    icon: ContentCut,
    whatsappMessage: 'Olá! Gostaria de saber mais sobre a Tosa na Tesoura'
  },
  {
    title: 'Tosa Bebê',
  ...
  },
  {
    ...
    variant: 'green',
    icon: ContentCut,
    whatsappMessage: 'Olá! Gostaria de saber mais sobre a Tosa específica para a raça do meu pet'
  },
  {
  ...
  },
  {
    ...
    description: 'Limpeza cuidadosa dos ouvidos com produtos específicos para prevenir infecções.',
    linkText: 'SAIBA MAIS',
    variant: 'pink',
    icon: Shimmer,
    whatsappMessage: 'Olá! Gostaria de saber mais sobre a Limpeza de Ouvidos do meu pet'
  },
  {
  ...
  {
    title: 'Carding',
    description: 'Remoção profissional de pelagem morta e subpelo para renovação da camada de pelos.',
    linkText: 'SAIBA MAIS',
    variant: 'pink',
    icon: Shimmer,
    whatsappMessage: 'Olá! Gostaria de saber mais sobre o serviço de Carding'
  },
  {
    title: 'Pacote Mensal e Quinzenal',
  ...
  },
  {
    ...
    description: 'Buscamos e levamos seu pet com segurança e conforto em veículo adaptado.',
